      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center max-w-3xl mx-auto mb-16">
          <h2 className="text-3xl md:text-4xl font-bold text-slate-900 mb-4">
            Featured <span className="text-theme-maroon">Categories</span>
          </h2>
          ...
          {categories.map((category, index) => (
            <div
              ...
              <div className="w-full h-48 mb-6 overflow-hidden rounded-2xl shadow-sm">
                <img src={category.image} alt={category.displayName} className="w-full h-full object-cover transition-transform duration-700 group-hover:scale-110" />
              </div>
