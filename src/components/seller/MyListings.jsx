...
const MyListings = ({ setActiveTab, setEditingProduct }) => {
  ...
  const getStatusBadge = (status) => {
    switch (status) {
      case "Active":
        return <span className="bg-emerald-100 text-emerald-700 px-2 py-1 rounded-md text-xs font-bold">Active</span>;
      case "Sold":
        return (
          <span className="bg-slate-200 text-slate-600 px-2 py-1 rounded-md text-xs font-bold flex items-center gap-1">
                    ...
                    <td className="p-4">
                      <div className="flex items-center gap-3 text-sm font-bold text-slate-500">
                        ...
                        <span className="flex items-center gap-1" title="Wishlist">
                          <Heart className="w-4 h-4 text-rose-400" /> {item.wishlistCount}
                        </span>
                      </div>
                    </td>
