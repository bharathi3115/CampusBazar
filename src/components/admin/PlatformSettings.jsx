      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        ...
        <button
          ...
          className={`flex items-center justify-center gap-2 px-6 py-2.5 rounded-xl font-bold transition-all shadow-lg w-44 ${
            showSuccess ? "bg-green-600 text-white shadow-green-600/20" : "bg-theme-maroon text-white hover:bg-theme-dark-maroon shadow-theme-maroon/20"
          }`}>
          {isSaving ? (
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div className="flex items-center justify-between p-4 rounded-2xl bg-slate-50 border border-slate-100 hover:border-theme-maroon/30 transition-colors">
            ...
            <button
              ...
              className={`w-12 h-6 rounded-full relative flex-shrink-0 transition-colors ${settings.enableChat ? "bg-theme-maroon" : "bg-slate-300"}`}>
          ...
          <div className="flex items-center justify-between p-4 rounded-2xl bg-slate-50 border border-slate-100 hover:border-theme-maroon/30 transition-colors">
            ...
            <button
              onClick={() => toggleSetting("enableWishlist")}
              className={`w-12 h-6 rounded-full relative flex-shrink-0 transition-colors ${settings.enableWishlist ? "bg-theme-maroon" : "bg-slate-300"}`}>
          ...
          <div className="flex items-center justify-between p-4 rounded-2xl bg-slate-50 border border-slate-100 hover:border-theme-maroon/30 transition-colors">
            ...
            <button
              onClick={() => toggleSetting("enableReports")}
              className={`w-12 h-6 rounded-full relative flex-shrink-0 transition-colors ${settings.enableReports ? "bg-theme-maroon" : "bg-slate-300"}`}>
