    ...
    <section className="py-24 bg-white relative overflow-hidden" id="how-it-works">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="relative">
          ...
          <div className="hidden lg:block absolute top-16 left-[15%] right-[15%] h-1 bg-gradient-to-r from-purple-200 via-fuchsia-200 to-purple-200 -z-10 rounded-full opacity-60"></div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-12 lg:gap-8">
            {steps.map((step, index) => (
              <div key={step.id} className="relative flex flex-col items-center text-center group">
                ...
                {/* Content */}
                <h3 className="text-2xl font-bold text-slate-900 mb-4 group-hover:text-purple-600 transition-colors">{step.title}</h3>
