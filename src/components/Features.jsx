    ...
    <section className="py-20 bg-gray-50 border-t border-gray-100">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          {/* How It Works */}
          <div>
            <h2 className="text-3xl font-bold text-gray-900 mb-8">How It <span className="text-purple-700">Works</span></h2>
          ...
          <div className="bg-purple-900 rounded-[2.5rem] p-8 md:p-12 text-white relative overflow-hidden shadow-2xl">
             ...
             <div className="relative z-10">
                <h2 className="text-3xl font-bold mb-8">Why Use <br/><span className="text-purple-300">CampusBazaar?</span></h2>
                ...
                <button className="mt-10 w-full bg-white text-purple-900 font-bold py-4 rounded-xl hover:bg-gray-100 transition-colors shadow-lg text-lg">
                  Join the Community
                </button>
             </div>
          </div>
