        ...
        <div className="flex justify-between h-20 items-center">
          ...
          <div className="hidden lg:flex items-center space-x-4">
            {ACTION_LINKS.map(({ to, label }) => (
              <Link key={to} to={to} className="flex items-center gap-2 bg-theme-maroon text-white px-5 py-2.5 rounded-full font-medium hover:bg-theme-dark-maroon transition-all transform hover:-translate-y-0.5 shadow-md shadow-theme-maroon/30">
                {label}
              </Link>
            ))}
          </div>
