        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-12 mb-16">
          ...
          <div className="lg:col-span-2 space-y-6">
            <div className="flex items-center gap-2 cursor-pointer">
              ...
              <span className="font-extrabold text-2xl text-white tracking-tight">Campus<span className="text-blue-500">Bazar</span></span>
            </div>
          ...
          <div>
            ...
            <ul className="space-y-4">
              ...
              <li><a href="#" className="hover:text-blue-400 transition-colors">Sell Item</a></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-4">
              ...
              <li><a href="#" className="hover:text-blue-400 transition-colors">Student Guidelines</a></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-4">
              ...
              <li className="pt-2"><a href="#" className="hover:text-blue-400 transition-colors">Email Support</a></li>
              <li><a href="#" className="hover:text-blue-400 transition-colors">Campus Support Team</a></li>
            </ul>
          </div>
        </div>
