...
import { 
  Users, ShoppingBag, AlertTriangle, BarChart3, Settings, 
  Layers, LogOut, Bell, Search, Megaphone, ShieldCheck,
  LayoutDashboard
} from 'lucide-react';
...
const AdminDashboard = () => {
  ...
  const navItems = [
    ...
    { id: 'listings', label: 'Listing Management', icon: <ShoppingBag className="w-5 h-5" /> },
  ...
  const renderContent = () => {
    switch (activeTab) {
      ...
      case 'reports': return <ReportedListings />;
